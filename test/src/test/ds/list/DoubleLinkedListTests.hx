...
class DoubleLinkedListTests extends TestCase {
    public function new() {
        test_new();
        test_length();
    ...
    function test_new() {
        assertNExcept(() -> new DoubleLinkedList<Int>());
        assert_empty(new DoubleLinkedList<Int>());
    }
    ...
    function test_remove() {
        ...
        var c = new DoubleLinkedList<Int>();
        c.push(0);
        c.push(1);
        c.push(2);

        var d = new DoubleLinkedList<Int>();
        d.push(0);
        d.push(2);
    ...
    function test_creating() {
        ...
        var b = new DoubleLinkedList<Int>();
        b.push(2);
        b.push(1);
        b.push(0);
        ...
        assert_equal(a.concat(new DoubleLinkedList<Int>()), a);
    ...
    function test_transforming() {
        ...
        var d = new DoubleLinkedList<String>();
        d.push("0");
        d.push("1");
        d.push("2");
        d.push("3");
    ...
    function assert_empty(l:DoubleLinkedList<Dynamic>, ?pos:PosInfos) {
        assert(l.length == 0, "length", pos);
        assert(l.isEmpty(), "isEmpty", pos);
    }

    function assert_notEmpty(l:DoubleLinkedList<Dynamic>, ?pos:PosInfos) {
        assert(l.length != 0, "length", pos);
        assert(!l.isEmpty(), "isEmpty", pos);
    }

    function assert_equal<T>(l1:DoubleLinkedList<T>, l2:DoubleLinkedList<T>, ?pos:PosInfos) {
        var it1 = l1.iterator();
        var it2 = l2.iterator();
